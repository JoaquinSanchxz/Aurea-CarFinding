...
def get_coches_net_fixtures() -> List[RawListing]:
    ...
    return [
        ...
        RawListing(
            ...
            price=9900.0, make="Volkswagen", model="Golf", year=2018, mileage_km=82000,
            fuel="diesel", transmission="manual", location="Lucena, ES",
        ...
        RawListing(
            ...
            price=9800.0, make="Volkswagen", model="Golf", year=2018, mileage_km=88000,
            fuel="diesel", transmission="manual", location="Rute, ES",
        ...
        RawListing(
            ...
            price=9750.0, make="Volkswagen", model="Golf", year=2018, mileage_km=90000,
            fuel="diesel", transmission="manual", location="Lucena, ES",
        ...
        RawListing(
            ...
            price=9950.0, make="Volkswagen", model="Golf", year=2018, mileage_km=80000,
            fuel="diesel", transmission="automatic", location="Lucena, ES",
            published_at=(now - timedelta(days=1)).isoformat(), raw_data={}
        ),
        RawListing(
            ...
            price=9850.0, make="Volkswagen", model="Golf", year=2018, mileage_km=84000,
            fuel="diesel", transmission="manual", location="Rute, ES",
            published_at=(now - timedelta(days=2)).isoformat(), raw_data={}
        ),
        RawListing(
            ...
            price=9900.0, make="Volkswagen", model="Golf", year=2018, mileage_km=86000,
            fuel="diesel", transmission="manual", location="Lucena, ES",
        ...
        RawListing(
            ...
            price=9600.0, make="Volkswagen", model="Golf", year=2018, mileage_km=92000,
            fuel="diesel", transmission="manual", location="Rute, ES",
            published_at=(now - timedelta(days=2)).isoformat(), raw_data={}
        ),
        RawListing(
            ...
            price=9700.0, make="Volkswagen", model="Golf", year=2018, mileage_km=85000,
            fuel="diesel", transmission="manual", location="Lucena, ES",
            published_at=(now - timedelta(days=3)).isoformat(), raw_data={}
        ),
    ]
